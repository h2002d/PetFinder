...
// NaN/Infinite
#if defined(FOR_WINDOWS) || defined(FOR_WINRT) || defined(FOR_UWP) || defined(_MSC_VER)
#  define L_ISNAN _isnan
#else
#  define L_ISNAN isnan
#endif // #if defined(FOR_WINDOWS) || defined(FOR_WINRT) || defined(FOR_UWP) || defined(_MSC_VER)
