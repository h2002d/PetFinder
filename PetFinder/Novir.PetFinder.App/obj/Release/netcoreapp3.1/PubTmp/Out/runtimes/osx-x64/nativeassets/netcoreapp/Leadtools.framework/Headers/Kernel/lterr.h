...
#define ERROR_LEADTOOLS_LAST_USED   -1872
#define ERROR_LEADTOOLS_NEXT        -1873
...
typedef enum
{
   ...
   ERROR_LVKRN_MISSING              = -353,  // LVKRN DLL is missing
   ...
   ERROR_LCMRC_MISSING              = -1793, // LCMRC DLL is missing
   ERROR_LCPDF_MISSING              = -1794, // LCPDF DLL is missing
...
typedef enum
{
   ERROR_SANE_CANCELLED      = SUCCESS_ABORT,       // Operation cancelled
