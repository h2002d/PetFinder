...
typedef L_INT(pEXT_FUNCTION pDicomL_SaveBitmap)(L_TCHAR* pszFile,
...
{
   L_UINT                           uStructSize;
   PRIVATEKEYPASSWORD               pfnPrivateKeyPassword;  L_VOID *pUserDataPrivateKeyPassword;
