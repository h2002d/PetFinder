...
#define AAMVA_EYE_COLORS_COUNT 10

/* Number of defined hair colors */
#define AAMVA_HAIR_COLORS_COUNT 9
...
#endif //#ifdef LEADTOOLS_V20_OR_LATER
...
#if defined(FOR_WINDOWS) || defined(FOR_WINRT)
