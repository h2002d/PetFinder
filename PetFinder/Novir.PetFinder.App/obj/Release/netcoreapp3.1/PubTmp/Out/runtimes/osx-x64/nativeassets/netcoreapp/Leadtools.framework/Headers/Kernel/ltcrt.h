...
#if defined(_MSC_VER) || defined(FOR_WINDOWS) || defined(FOR_WINRT) || defined(FOR_UWP)
...
#else
   #define L_USE_LTCRT_H
#endif // #if defined(_MSC_VER) || defined(FOR_WINDOWS) || defined(FOR_WINRT) || defined(FOR_UWP)
